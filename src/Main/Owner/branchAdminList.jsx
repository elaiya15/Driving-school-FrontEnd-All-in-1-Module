...
const AdminTable = () => {
  ...
  useEffect(() => {
    ...
    //     // ✅ dataset is directly in response.data
              ...
              {admins && admins.length > 0 ? (
                ...
                admins.map((admin, index) => (
                  <tr key={admin._id} className="bg-white border-b">
                    ...
                    {/* <td className="px-6 py-4">{admin.userId?.username}</td>
                    <td className="px-6 py-4">{admin.email}</td> */}
                    <td className="px-6 py-4">{admin.gender}</td>
                    <td className="px-6 py-4">{admin.mobileNumber}</td>
                    <td className="px-6 py-4">
                      {admin.branchId && admin.branchId.branchName ? admin.branchId.branchName : "N/A"}
                        </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() =>
                            navigate(`/owner/branch-admin/${admin.branchId._id}/${admin._id}/view`)
                          }
                        ...
                        <button
                          onClick={() =>
                            navigate(`/owner/branch-admin/${admin.branchId._id}/${admin._id}/edit`)
                          }
                          className="px-2 py-1 bg-gray-100 rounded hover:bg-gray-200"
                        >
