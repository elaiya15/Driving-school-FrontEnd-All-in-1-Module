...
const Form5Certificate = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    fatherName:      learner?.fathersName || '',
    address:         learner?.address || '',
    enrollmentDate:   learner?.joinDate ? moment(learner.joinDate).format('DD-MM-YYYY') : '',
    serialNumber:    learner?.serialNumber || '',
    course:          learner?.course || '',
    syllabusFrom:    learner?.syllabusFrom || '',
    syllabusTo:      learner?.syllabusTo || '',
  });
  ...
  return (
    ...
    ref={componentRef} 
        ...
        className={`w-[210mm] min-h-[297mm] mx-auto p-10 text-black bg-white text-[15px] leading-snug border border-gray-300 `}
